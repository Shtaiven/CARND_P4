...
I used a combination of color and gradient thresholds to generate a binary image (thresholding steps in the 5th cell of the IPython notebook). Here's an example of my output for this step.
